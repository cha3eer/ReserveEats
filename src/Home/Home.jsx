  ...
  import Homesty from"./Home.module.css"
  import one from "./../images/image 110.png"
  import two from "./../images/image 111.png"
  import three from "./../images/charming-female-blowing-candles-birthday-cake-after-making-her-wish-party 1.png"
  import four from "./../images/kebab-set-table 1.png"
  import five from "./../images/happy-man-wife-sunny-day 1.png"
  import six from "./../images/group-friends-eating-restaurant 1.png"
  ...
  const Home = () => {
    return (
      <div> 
        ...
        <h5>Best food for Your Taste</h5>
        <div className={Homesty.mybtn}>
          <button><a href="#">Book A Table</a></button>
          <button><a href="#">Explore Menu</a></button>
        </div>
      </div>

      <div className={Homesty.menu}>
        <h4>Browse Our Menu</h4>
        <div className={Homesty.card}>
          <div className={Homesty.item}>
            <svg
      ...
      <div className={Homesty.about}>
        <div className={Homesty.content}>
          <div className={Homesty.imgandcard}>
            <img src={two} alt="" />
            
          </div>

          <div className={Homesty.tex}>
    ...
    and dedication, strives to make every visit an unforgettable event.
      ...
      <div className={Homesty.menu1}>
        <h4 style={{ fontWeight: 'bolder', fontSize: 'x-large', paddingTop: '40px' }}>
    We also offer unique services for your events
  </h4>

        <div className={Homesty.card1}>
          <div className={Homesty.item1}>
            <img src={four} alt="" />
            <h4>Caterings</h4>
            <h4>
              In the new era of technology we look in the future with certainty
